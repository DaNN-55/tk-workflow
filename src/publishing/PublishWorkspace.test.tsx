...
import { PublishWorkspace } from "../App";
...
describe("发布队列", () => {
  ...
  it("要求 Owner 勾选手工发布声明并填写理由后才记录 published", async () => {
    ...
    render(<PublishWorkspace accountsById={new Map()} artifacts={[]} episodes={[episode]} isPending="" onSelectEpisode={vi.fn()} onTransition={onTransition} selectedEpisode={episode} tasks={[]} />);
